...
func (*SnippetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_SnippetsShared_e41bb17053c819cf, []int{0}
}
...
func (*SnippetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_SnippetsShared_e41bb17053c819cf, []int{1}
}
...
func (c *snippetsClient) SayHello(ctx context.Context, in *SnippetRequest, opts ...grpc.CallOption) (*SnippetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/SnippetsShared.Snippets/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Snippets_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/SnippetsShared.Snippets/SayHello",
	}
...
func init() {
	proto.RegisterFile("SnippetsShared.proto", fileDescriptor_SnippetsShared_e41bb17053c819cf)
}

var fileDescriptor_SnippetsShared_e41bb17053c819cf = []byte{
	...
	0x04, 0x17, 0x7b, 0x6e, 0x6a, 0x71, 0x71, 0x62, 0x3a, 0x4c, 0x3f, 0x8c, 0x6b, 0x14, 0xc9, 0xc5,
	0x01, 0xb3, 0x5a, 0xc8, 0x97, 0x8b, 0x23, 0x38, 0xb1, 0xd2, 0x23, 0x35, 0x27, 0x27, 0x5f, 0x48,
	0x4e, 0x0f, 0xcd, 0x9d, 0xa8, 0xce, 0x91, 0x92, 0xc7, 0x29, 0x0f, 0xb1, 0x52, 0x89, 0x21, 0x89,
	0x0d, 0xec, 0x35, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xe1, 0x8f, 0x14, 0xbe, 0xf2, 0x00,
	0x00, 0x00,
}
